import { pgTable, uuid, varchar, text, numeric, integer, timestamp, date, boolean, foreignKey, unique, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const auditAction = pgEnum("audit_action", ['BORROW_REQUEST_CREATED', 'BORROW_REQUEST_APPROVED', 'BORROW_REQUEST_REJECTED', 'RETURN_REQUEST_CREATED', 'RETURN_REQUEST_APPROVED', 'RETURN_REQUEST_REJECTED', 'BOOK_BORROWED', 'BOOK_RETURNED', 'INVENTORY_UPDATED', 'USER_LOGIN', 'USER_LOGOUT', 'ADMIN_ACTION'])
export const auditActorType = pgEnum("audit_actor_type", ['USER', 'ADMIN', 'SYSTEM'])
export const borrowRequestStatus = pgEnum("borrow_request_status", ['PENDING', 'APPROVED', 'REJECTED', 'RETURN_REQUEST_PENDING', 'RETURNED'])
export const borrowStatus = pgEnum("borrow_status", ['BORROWED', 'RETURNED'])
export const notificationType = pgEnum("notification_type", ['BOOK_AVAILABLE', 'BORROW_APPROVED', 'BORROW_REJECTED', 'RETURN_APPROVED', 'OVERDUE_REMINDER'])
export const requestStatus = pgEnum("request_status", ['PENDING', 'APPROVED', 'REJECTED', 'CANCELLED', 'RETURN_PENDING', 'RETURNED'])
